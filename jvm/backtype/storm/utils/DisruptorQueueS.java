 ...
 */
public class DisruptorQueueS implements IStatefulObject {
    ...
    public DisruptorQueueS(String queueName, int size, long timeout) {
        this._queueName = PREFIX + queueName;
        _buffer = new ArrayBlockingQueue(size, false);
     ...
     */
    // the second parameter is useless in here.
